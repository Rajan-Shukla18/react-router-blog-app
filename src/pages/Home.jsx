...
const Home = () => {
  ...
  return (
    <>
      <SEO
        title="Fieldnotes — Notes on Technology & Building"
        description="Fieldnotes is a personal blog about technology, learning, design, and building for the web."
      />
      ...
      <div className="mx-auto max-w-nav px-6 py-10">
        <header className="mb-12">
          ...
          <p className="mb-8 max-w-2xl text-lg leading-8 text-muted">
            Writing on React, AI-assisted development, and the design choices
            that separate a working interface from a good one.
          </p>
          ...
          <ul className="flex flex-wrap gap-3">
            {topics.map((topic) => (
              <li
                key={topic}
                className="rounded-md bg-[rgba(31,94,61,0.08)] px-3.5 py-1.5 font-serif text-[0.94rem] font-semibold text-accent"
              >
                {topic}
              </li>
            ))}
